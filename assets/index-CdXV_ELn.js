...
<body class="bg-[#050505] text-zinc-300 min-h-screen flex items-center justify-center font-['Inter',sans-serif] overflow-x-hidden m-0 p-0" style="background-color: #050505;">
    ...
    <\/script>
            ...
            scene.add(group);`,Oy="core.position.y = 0.25;",By=`const coreBaseY = 1.7;
            ...
            group.add(coreShadow);`,ky="group.position.y = Math.sin(time * 0.5) * 0.2;",zy=`group.position.y = Math.sin(time * 0.5) * 0.2;
...
`,Gy=`
  ...
  <\/script>
`;function Vy(){let t=My;return t=t.replace("https://cdn.skypack.dev/three@0.136.0",Ey),t=t.replace(Ty,wy),t=t.replace(Cy,Ry),t=t.replace(Py,by),t=t.replace(Ly,Iy),t=t.replace(Ny,Dy),t=t.replace(Uy,Fy),t=t.replace(Oy,By),t=t.replace(ky,zy),t=t.replace(/<script[^>]*cdn\.tailwindcss\.com[^>]*><\/script>/gi,""),t=t.replace(/<script[^>]*code\.iconify\.design[^>]*><\/script>/gi,""),t=t.replace(/<link[^>]*fonts\.googleapis\.com[^>]*>/gi,""),t=t.replace(/(<img[^>]*\s)src="https:\/\/images\.unsplash\.com[^"]*"/gi,"$1"),t=t.replace(/<\/head>/i,`${Hy}</head>`),t=t.replace(/<\/body>/i,`${Gy}</body>`),t}const Vc=(t,e,n)=>Math.min(n,Math.max(e,t));function Wy({hue:t=0,saturation:e=1,brightness:n=1,className:i,title:r="Logic Core"}){const s=it.useMemo(()=>Vy(),[]),a=Vc(t,-180,180),o=Vc(e,0,2),l=Vc(n,.35,1.65),c=a===0&&o===1&&l===1?void 0:`hue-rotate(${a}deg) saturate(${o}) brightness(${l})`;return E.jsx("iframe",{className:i,title:r,srcDoc:s,loading:"eager",sandbox:"allow-scripts allow-same-origin",style:{display:"block",width:"100%",height:"100%",border:0,filter:c,background:"#050505"}})}function on({text:t,segments:e,speed:n=55,active:i=!0}){const r=e||[{text:t}],s=r.map(d=>d.text).join(""),[a,o]=it.useState(0);it.useEffect(()=>{if(!i){o(s.length);return}o(0);const d=setInterval(()=>{o(p=>p+1>=s.length?(clearInterval(d),s.length):p+1)},n);return()=>clearInterval(d)},[s,i,n]);const l=a>=s.length;let c=0;const h=r.map((d,p)=>{const x=c;c+=d.text.length;const y=Math.max(0,Math.min(d.text.length,a-x));return{className:d.className,nowrapWith:d.nowrapWith,str:d.text.slice(0,y)}}),u=[];return h.forEach((d,p)=>{d.nowrapWith&&u.length>0?u[u.length-1].push(d):u.push([d])}),E.jsxs("span",{"aria-label":s,children:[E.jsx("span",{"aria-hidden":"true",children:u.map((d,p)=>{const x=d.map((y,m)=>E.jsx("span",{className:y.className,children:y.str},m));return d.length>1?E.jsx("span",{style:{whiteSpace:"nowrap"},children:x},p):E.jsx("span",{className:d[0].className,children:d[0].str},p)})}),E.jsx("span",{className:`typewriter-cursor${l?" typewriter-cursor--done":""}`,"aria-hidden":"true"})]})}function ja({lines:t,startDelay:e=.5,active:n}){return E.jsx("div",{className:"reveal-lines",children:t.map((i,r)=>E.jsx("p",{className:"prose reveal-line",style:n?{animationDelay:`${e+r*.28}s`}:{opacity:1,animation:"none"},children:i},i))})}function ih({variant:t="converge",className:e=""}){const n=(i,r,s=46,a=26,o="iso-plate")=>E.jsx("path",{className:o,d:`M${i},${r} l${s/2},${-a/2} l${s/2},${a/2} l${-s/2},${a/2} Z`});return t==="scatter"?E.jsxs("svg",{className:`iso ${e}`,viewBox:"0 0 260 170",role:"img","aria-label":"流程散落在多個檔案之間",children:[n(20,60),n(96,34),n(150,92),n(60,118),n(178,52,46,26,"iso-plate iso-accent"),E.jsxs("g",{className:"iso-link",children:[E.jsx("path",{d:"M66,60 L119,34"}),E.jsx("path",{d:"M119,47 L173,92"}),E.jsx("path",{d:"M83,118 L142,92"}),E.jsx("path",{d:"M142,47 L201,52"})]})]}):E.jsxs("svg",{className:`iso ${e}`,viewBox:"0 0 260 170",role:"img","aria-label":"流程收斂成單一路徑",children:[n(24,118),n(78,96),n(132,74),n(186,52,46,26,"iso-plate iso-accent"),E.jsxs("g",{className:"iso-link",children:[E.jsx("path",{d:"M70,118 L101,96"}),E.jsx("path",{d:"M124,96 L155,74"}),E.jsx("path",{d:"M178,74 L209,52"})]})]})}const jy=["團隊每日花費大量時間，處理重複性資料搬移、人工核對與跨系統作業。","當優秀的人力被困在繁瑣的例行事務中，","不僅無形中消耗了工作熱情，也限制了團隊投入高價值業務開拓的空間。"];function Xy({active:t}){return E.jsxs("section",{className:"thesis slide-content",children:[E.jsx("div",{className:"rail",children:E.jsx("span",{className:"rail-label",children:"我的觀察"})}),E.jsx("div",{className:"thesis-body",children:E.jsxs("div",{className:"thesis-block",children:[E.jsx("h2",{className:"thesis-heading",children:E.jsx(on,{text:"作業重複的日常消耗",active:t})}),E.jsx(ja,{lines:jy,startDelay:.55,active:t})]})}),E.jsx("figure",{className:"thesis-figure",children:E.jsx(ih,{variant:"scatter",className:"iso-visible"})})]})}const $y=["梳理跨部門與跨系統的銜接點，","串接半自動化輔助工具與自動化串流。","讓資料順暢流轉、減少無謂的人工轉手，","打造高效率且具備彈性的敏捷協作架構。"];function Yy({active:t}){return E.jsxs("section",{className:"thesis slide-content",children:[E.jsx("div",{className:"rail",children:E.jsx("span",{className:"rail-label",children:"我的觀察"})}),E.jsx("div",{className:"thesis-body",children:E.jsxs("div",{className:"thesis-block thesis-block--solution",children:[E.jsx("h2",{className:"thesis-heading",children:E.jsx(on,{text:"讓自動化成為營運與業務的常態",active:t})}),E.jsx(ja,{lines:$y,startDelay:.55,active:t})]})}),E.jsx("figure",{className:"thesis-figure",children:E.jsx(ih,{variant:"converge",className:"iso-visible"})})]})}const qy=["這幾個月觀察下來，發現有 IT 資源排程比較緊湊、","外部平台沒開放 API 等狀況，","亦或是一些操作細節與工作日常，需要每日不斷重複，","並且得長時間面對散落在各個檔案裡的資料。"];function Ky({active:t}){return E.jsxs("section",{className:"ai slide-content",children:[E.jsx("div",{className:"rail",children:E.jsx("span",{className:"rail-label",children:"AI的重要性"})}),E.jsxs("div",{className:"ai-body",children:[E.jsx("h2",{className:"thesis-heading",children:E.jsx(on,{text:"痛點",active:t})}),E.jsx(ja,{lines:qy,startDelay:.5,active:t})]}),E.jsx("figure",{className:`ai-figure ai-figure--image${t?" is-active":""}`,children:E.jsx("img",{src:"bottleneck.png",alt:"散落在各處的檔案與重複性作業"})})]})}const Zy=`attribute vec2 aPos;
