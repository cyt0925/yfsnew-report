...
<body class="bg-[#050505] text-zinc-300 min-h-screen flex items-center justify-center font-['Inter',sans-serif] overflow-x-hidden m-0 p-0" style="background-color: #050505;">
    ...
    <\/script>
            ...
            scene.add(group);`,Ny="core.position.y = 0.25;",Dy=`const coreBaseY = 1.7;
...
`+ow(t.getShaderSource(e),a)}else return r}function cw(t,e){const n=lw(e);return`vec4 ${t}( vec4 value ) { return ${n[0]}( ${n[1]}( value ) ); }`}function uw(t,e){let n;switch(e){case AS:n="Linear";break;case CS:n="Reinhard";break;case RS:n="Cineon";break;case bS:n="ACESFilmic";break;case LS:n="AgX";break;case NS:n="Neutral";break;case PS:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Do=new U;function fw(){Ze.getLuminanceCoefficients(Do);const t=Do.x.toFixed(4),e=Do.y.toFixed(4),n=Do.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
