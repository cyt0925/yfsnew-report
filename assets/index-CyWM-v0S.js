...
`,By=`
  ...
  <\/script>
`;function ky(){let t=_y;return t=t.replace("https://cdn.skypack.dev/three@0.136.0",xy),t=t.replace(yy,Sy),t=t.replace(Ey,Ty),t=t.replace(wy,Ay),t=t.replace(Cy,Py),t=t.replace(Ry,by),t=t.replace(Ly,Dy),t=t.replace(Ny,Iy),t=t.replace(Uy,Fy),t=t.replace(/<script[^>]*cdn\.tailwindcss\.com[^>]*><\/script>/gi,""),t=t.replace(/<script[^>]*code\.iconify\.design[^>]*><\/script>/gi,""),t=t.replace(/<link[^>]*fonts\.googleapis\.com[^>]*>/gi,""),t=t.replace(/(<img[^>]*\s)src="https:\/\/images\.unsplash\.com[^"]*"/gi,"$1"),t=t.replace(/<\/head>/i,`${Oy}</head>`),t=t.replace(/<\/body>/i,`${By}</body>`),t}const Hc=(t,e,n)=>Math.min(n,Math.max(e,t));function zy({hue:t=0,saturation:e=1,brightness:n=1,className:i,title:r="Logic Core"}){const s=it.useMemo(()=>ky(),[]),a=Hc(t,-180,180),o=Hc(e,0,2),l=Hc(n,.35,1.65),c=a===0&&o===1&&l===1?void 0:`hue-rotate(${a}deg) saturate(${o}) brightness(${l})`;return C.jsx("iframe",{className:i,title:r,srcDoc:s,loading:"eager",sandbox:"allow-scripts allow-same-origin",style:{display:"block",width:"100%",height:"100%",border:0,filter:c,background:"#050505"}})}function Qn({text:t,segments:e,speed:n=55,active:i=!0}){const r=e||[{text:t}],s=r.map(d=>d.text).join(""),[a,o]=it.useState(0);it.useEffect(()=>{if(!i){o(s.length);return}o(0);const d=setInterval(()=>{o(p=>p+1>=s.length?(clearInterval(d),s.length):p+1)},n);return()=>clearInterval(d)},[s,i,n]);const l=a>=s.length;let c=0;const h=r.map((d,p)=>{const _=c;c+=d.text.length;const y=Math.max(0,Math.min(d.text.length,a-_));return{className:d.className,nowrapWith:d.nowrapWith,str:d.text.slice(0,y)}}),f=[];return h.forEach((d,p)=>{d.nowrapWith&&f.length>0?f[f.length-1].push(d):f.push([d])}),C.jsxs("span",{"aria-label":s,children:[C.jsx("span",{"aria-hidden":"true",children:f.map((d,p)=>{const _=d.map((y,m)=>C.jsx("span",{className:y.className,children:y.str},m));return d.length>1?C.jsx("span",{style:{whiteSpace:"nowrap"},children:_},p):C.jsx("span",{className:d[0].className,children:d[0].str},p)})}),C.jsx("span",{className:`typewriter-cursor${l?" typewriter-cursor--done":""}`,"aria-hidden":"true"})]})}function Va({lines:t,startDelay:e=.5,active:n}){return C.jsx("div",{className:"reveal-lines",children:t.map((i,r)=>C.jsx("p",{className:"prose reveal-line",style:n?{animationDelay:`${e+r*.28}s`}:{opacity:1,animation:"none"},children:i},i))})}function th({variant:t="converge",className:e=""}){const n=(i,r,s=46,a=26,o="iso-plate")=>C.jsx("path",{className:o,d:`M${i},${r} l${s/2},${-a/2} l${s/2},${a/2} l${-s/2},${a/2} Z`});return t==="scatter"?C.jsxs("svg",{className:`iso ${e}`,viewBox:"0 0 260 170",role:"img","aria-label":"流程散落在多個檔案之間",children:[n(20,60),n(96,34),n(150,92),n(60,118),n(178,52,46,26,"iso-plate iso-accent"),C.jsxs("g",{className:"iso-link",children:[C.jsx("path",{d:"M66,60 L119,34"}),C.jsx("path",{d:"M119,47 L173,92"}),C.jsx("path",{d:"M83,118 L142,92"}),C.jsx("path",{d:"M142,47 L201,52"})]})]}):C.jsxs("svg",{className:`iso ${e}`,viewBox:"0 0 260 170",role:"img","aria-label":"流程收斂成單一路徑",children:[n(24,118),n(78,96),n(132,74),n(186,52,46,26,"iso-plate iso-accent"),C.jsxs("g",{className:"iso-link",children:[C.jsx("path",{d:"M70,118 L101,96"}),C.jsx("path",{d:"M124,96 L155,74"}),C.jsx("path",{d:"M178,74 L209,52"})]})]})}const Hy=["團隊每日花費大量時間，處理重複性資料搬移、人工核對與跨系統作業。","當優秀的人力被困在繁瑣的例行事務中，","不僅無形中消耗了工作熱情，也限制了團隊投入高價值業務開拓的空間。"];function Gy({active:t}){return C.jsxs("section",{className:"thesis slide-content",children:[C.jsx("div",{className:"rail",children:C.jsx("span",{className:"rail-label",children:"我的觀察"})}),C.jsx("div",{className:"thesis-body",children:C.jsxs("div",{className:"thesis-block",children:[C.jsx("h2",{className:"thesis-heading",children:C.jsx(Qn,{text:"作業重複的日常消耗",active:t})}),C.jsx(Va,{lines:Hy,startDelay:.55,active:t})]})}),C.jsx("figure",{className:"thesis-figure",children:C.jsx(th,{variant:"scatter",className:"iso-visible"})})]})}const Vy=["梳理跨部門與跨系統的銜接點，","串接半自動化輔助工具與自動化串流。","讓資料順暢流轉、減少無謂的人工轉手，","打造高效率且具備彈性的敏捷協作架構。"];function Wy({active:t}){return C.jsxs("section",{className:"thesis slide-content",children:[C.jsx("div",{className:"rail",children:C.jsx("span",{className:"rail-label",children:"我的觀察"})}),C.jsx("div",{className:"thesis-body",children:C.jsxs("div",{className:"thesis-block thesis-block--solution",children:[C.jsx("h2",{className:"thesis-heading",children:C.jsx(Qn,{text:"讓自動化成為營運與業務的常態",active:t})}),C.jsx(Va,{lines:Vy,startDelay:.55,active:t})]})}),C.jsx("figure",{className:"thesis-figure",children:C.jsx(th,{variant:"converge",className:"iso-visible"})})]})}const jy=["這幾個月觀察下來，發現有 IT 資源排程比較緊湊、","外部平台沒開放 API 等狀況，","亦或是一些操作細節與工作日常，需要每日不斷重複，","並且得長時間面對散落在各個檔案裡的資料。"];function Xy({active:t}){return C.jsxs("section",{className:"ai slide-content",children:[C.jsx("div",{className:"rail",children:C.jsx("span",{className:"rail-label",children:"AI的重要性"})}),C.jsxs("div",{className:"ai-body",children:[C.jsx("h2",{className:"thesis-heading",children:C.jsx(Qn,{text:"痛點",active:t})}),C.jsx(Va,{lines:jy,startDelay:.5,active:t})]}),C.jsx("figure",{className:`ai-figure ai-figure--image${t?" is-active":""}`,children:C.jsx("img",{src:"bottleneck.png",alt:"散落在各處的檔案與重複性作業"})})]})}const $y=`attribute vec2 aPos;
